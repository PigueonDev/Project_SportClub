      ...
      <Row className="g-0 h-100">
        ...
        <Col md={10} className="p-4 p-md-5 overflow-auto">
              ...
              <Card className="border-0 shadow-sm h-100" style={{ backgroundColor: 'rgba(255,255,255,0.04)' }}>
                <Card.Body className="p-4">
                  <div className="d-flex justify-content-between align-items-center mb-4">
                    <h6 className="text-white-50 text-uppercase fw-bold mb-0" style={{ borderLeft: '3px solid #3B82F6', paddingLeft: '8px' }}>Mis Reservas</h6>
                    <Button variant="link" className="p-0 text-primary text-decoration-none" style={{ fontSize: '0.85rem' }} onClick={() => navigate('/user/mis-reservas')}>
                      Ver todas →
                    </Button>
                  </div>
          ...
          <Card className="border-0 shadow-sm" style={{ backgroundColor: 'rgba(255,255,255,0.04)' }}>
            <Card.Body className="p-4">
              <div className="d-flex justify-content-between align-items-center mb-4">
                <h6 className="text-white-50 text-uppercase fw-bold mb-0" style={{ borderLeft: '3px solid #3B82F6', paddingLeft: '8px' }}>Clases Disponibles</h6>
                <Button variant="link" className="p-0 text-primary text-decoration-none" style={{ fontSize: '0.85rem' }} onClick={() => navigate('/user/clases')}>
